      ...
      <div className=" flex  flex-col justify-center items-center  mt-28">
        ...
        <div className="lg:w-[80%] w-full md:px-6 px-3 mt-5  m-auto relative flex md:gap-3 gap-2 items-center ">
          ...
          <select className=" button-primary rounded-xl shadow-lg  border border-[#7042f861]  lg:px-4 md:px-4 px-2 md:py-2.5 py-2 font-normal text-gray-300">
            <option className=" bg-black    text-gray-300 " value="">Search By</option>
            <option className=" bg-black   text-gray-300 " lassName="button-primary   text-gray-300 " value="name">Name</option>
            <option className=" bg-black   text-gray-300 " value="batch">Batch</option>
            <option className=" bg-black   text-gray-300 " value="company">Company</option>
            <option className=" bg-black   text-gray-300 " value="designation">Designation</option>
          </select>
        ...
        <div className="flex flex-wrap items-center gap-3 justify-center pt-6">
            ...
            className={`button-primary shadow-lg  border border-[#7042f861] ${Branch === null && 'button-secondary'}`}>
                All
            </Button>
            {
                Branches.map((dept,index)=>(
                    ...
                    onClick={()=>{
                     ...
                     className={`button-primary shadow-lg  border border-[#7042f861] ${Branch === dept.value && 'button-secondary'}`}>
{dept.value}
                    </Button>
                ))
            }
